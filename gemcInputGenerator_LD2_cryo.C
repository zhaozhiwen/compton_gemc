...
//  const nEvent = 100;
  ...
  TFile *infile = new TFile("/var/phy/project/mepg/xl79/brem/prim_brem_spectrum.root");
  TH1F *hist = (TH1F*)infile->Get("prim_spectrum_523");
  Double_t bincount;
...
//  TH1F *h = new TH1F("h1","h1",1000,0,1000);
